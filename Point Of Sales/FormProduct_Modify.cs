...
namespace Point_Of_Sales
{
    public partial class FormProduct_Modify : Form
    {
        ...
        private void FormProduct_Modify_Load(object sender, EventArgs e)
        {
            ...
            cmdAddProduct.Parameters.Add("@getStock", MySqlDbType.Int16);
        ...
        private void FillFields()
        {
            ...
            txtStock.Text = ds.Tables["tblproduct"].Rows[0].ItemArray.GetValue(8).ToString();

            sCategoryID = int.Parse(ds.Tables["tblproduct"].Rows[0].ItemArray.GetValue(9).ToString());
            sSupplierID = int.Parse(ds.Tables["tblproduct"].Rows[0].ItemArray.GetValue(10).ToString());
        }
